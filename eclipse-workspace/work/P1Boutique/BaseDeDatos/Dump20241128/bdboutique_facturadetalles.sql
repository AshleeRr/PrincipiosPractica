...
CREATE TABLE `facturadetalles` (
  `idFacturaDetalles` int NOT NULL,
  ...
  CONSTRAINT `facturadetalles_ibfk_1` FOREIGN KEY (`idFactura`) REFERENCES `factura` (`idFactura`),
  CONSTRAINT `facturadetalles_ibfk_2` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`)
